  ...
  1: [
    {
      ...
      distractors: [
        ...
        },
        {
          label: '語順の取り違え',
          words: ['use', 'Did'],
          reason: 'Yes/No疑問では助動詞 Did を主語 you の前に出します。動詞を先に置く語順は疑問文になりません。',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      distractors: [
        ...
        },
        {
          label: '語順の取り違え',
          words: ['eaten', 'Have'],
          reason: '現在完了では Have を主語 you の前に出します。過去分詞を文頭に置く語順は疑問文になりません。',
        },
      ],
    },
  ],
  2: [
    {
      ...
      distractors: [
        ...
        },
        {
          label: '疑問詞の位置の取り違え',
          words: ['cooked', 'Who'],
          reason: '主語を問う wh は文頭に来ます。Who の直後に本動詞が続く語順を崩すと疑問文になりません。',
        },
      ],
    },
    {
  ...
  6: [
    {
      ...
      distractors: [
        ...
        },
        {
          ...
          words: ['Where', 'is'],
          reason: '従属節は where the station is の平叙語順です。疑問詞を文頭に出して is を主語の前に置くのは直接疑問の形です。',
        },
      ],
    },
    {
